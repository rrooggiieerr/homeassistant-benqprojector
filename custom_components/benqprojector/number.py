...
async def async_setup_entry(
    ...
    entity_descriptions = [
        ...
        NumberEntityDescription(key="keyst", name="Keystone", native_max_value=20, entity_category=EntityCategory.CONFIG, entity_registry_enabled_default=False,),
        NumberEntityDescription(key="hkeystone", name="Horizontal Keystone", native_max_value=20, entity_category=EntityCategory.CONFIG, entity_registry_enabled_default=False,),
        NumberEntityDescription(key="vkeystone", name="Vertical Keystone", native_max_value=20, entity_category=EntityCategory.CONFIG, entity_registry_enabled_default=False,),
        NumberEntityDescription(key="rgain", name="Red Gain", native_max_value=200, entity_category=EntityCategory.CONFIG, entity_registry_enabled_default=False,),
        NumberEntityDescription(key="ggain", name="Green Gain", native_max_value=200, entity_category=EntityCategory.CONFIG, entity_registry_enabled_default=False,),
        NumberEntityDescription(key="bgain", name="Blue Gain", native_max_value=200, entity_category=EntityCategory.CONFIG, entity_registry_enabled_default=False,),
        NumberEntityDescription(key="roffset", name="Red Offset", native_max_value=511, entity_category=EntityCategory.CONFIG, entity_registry_enabled_default=False,),
        NumberEntityDescription(key="goffset", name="Green Offset", native_max_value=511, entity_category=EntityCategory.CONFIG, entity_registry_enabled_default=False,),
        NumberEntityDescription(key="boffset", name="Blue Offset", native_max_value=511, entity_category=EntityCategory.CONFIG, entity_registry_enabled_default=False,),
        ...
        NumberEntityDescription(key="hdrbri", name="HDR Brightness", icon="mdi:brightness-6", native_min_value=-2, native_max_value=2, entity_category=EntityCategory.CONFIG, entity_registry_enabled_default=False,),
    ]
